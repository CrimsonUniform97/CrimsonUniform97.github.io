...
class TubeBlazerLight extends JFrame implements KeyListener
{
...
polygon_creation_1:
			for(int x = 0; x < 48; x++)
			{
				for(int i = 0; i < 5; i++)
				{
					...
					coords_x[9-i] = (int)(-Math.sin(((x+i)%48-.50001)*Math.PI/24)*7.5*h/(y+9)+w/2+.5);
					coords_y[9-i] = (int)(Math.cos(((x+i)%48-.50001)*Math.PI/24)*7.5*h/(y+9)+h/2+.5);
				}
...
polygon_creation_2:
			for(int x = 0; x < 48; x++)
			{
				for(int i = 0; i < 5; i++)
				{
					coords_x[i] = (int)(-Math.sin(((x+i)%48-.50001)*Math.PI/24)*7.5*h/8+w/2+.5);
					coords_y[i] = (int)(Math.cos(((x+i)%48-.50001)*Math.PI/24)*7.5*h/8+h/2+.5);
					coords_x[9-i] = (int)(-Math.sin(((x+i)%48-.50001)*Math.PI/24)*7.5*h/(y+9)+w/2+.5);
					coords_y[9-i] = (int)(Math.cos(((x+i)%48-.50001)*Math.PI/24)*7.5*h/(y+9)+h/2+.5);
				}
				polygon[y<<1][x] = new Polygon(coords_x, coords_y, 10);
